...
class FashionhmSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        with open("./csvFiles/SpiderMainCategoryLinksHM.csv", "r") as f:
    ...
    def parse_product_pages(self, response):
        ...
        for product_content in content.xpath('//li[@class="product-item"]'):
            ...
            item['productId'] = product_content.xpath(
                './/article[@class="hm-product-item"]/@data-articlecode').extract_first()
            ...
            item['productLink'] = "https://www2.hm.com" + \
                product_content.xpath(
                    './/a[@class="link"]/@href').extract_first()
            item['imageLink'] = "https:" + \
                product_content.xpath('.//img/@data-src').extract_first()
